 ...
 * 
 * Plugin Name: xpro_Widget_Business_Hours
 * Plugin URI: http://www.gaxdesigns.com
 * Description: A widget that displays business hours.
 * Version: 1.0
 * Author: Adi Purdila
 * Author URI: http://www.gaxdesigns.com
*/

class xpro_Widget_Business_Hours extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 
			...
			__( 'xpro: Business Hours', 'xpro' ),
			array(
				'classname'   => 'widget-business-hours',
				'description' => __( 'A custom widget that displays business hours.', 'xpro' )
			) 
		);
	}
	...
	public function form( $instance ) {
		...
		<!-- Title -->
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'xpro' ); ?></label>
			<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo esc_attr( $instance['title'] ); ?>">
		</p>

		<!-- Description -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_description' ); ?>"><?php _e( 'Description:', 'xpro' ); ?></label>
		...
		<!-- Monday-Friday -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_monday_friday' ); ?>"><?php _e( 'Monday-Friday:', 'xpro' ); ?></label>
		...
		<!-- Saturday -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_saturday' ); ?>"><?php _e( 'Saturday:', 'xpro' ); ?></label>
		...
		<!-- Sunday -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_sunday' ); ?>"><?php _e( 'Sunday:', 'xpro' ); ?></label>
	...
	public function widget( $args, $instance ) {
		...
		if ( $hours_monday_friday ) : ?>
			<li>
				<span><?php _e( 'Monday-Friday: ', 'xpro' ); ?></span>
		...
		if ( $hours_saturday ) : ?>
			<li>
				<span><?php _e( 'Saturday: ', 'xpro' ); ?></span>
...
add_action( 'widgets_init', create_function( '', 'register_widget( "xpro_Widget_Business_Hours" );' ) );
?>